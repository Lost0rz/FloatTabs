...
/// Commands sent by RemoteOrbit's semantic adapter. Keeping this IPC surface
/// separate from user-configurable KeyboardShortcuts means changing a
/// FloatTabs shortcut cannot break the remote's preset actions.
...
/// Receives RemoteOrbit commands from the distributed notification center.
/// The observer is owned for the lifetime of the app so commands work while
/// the FloatTabs panel is hidden as well as while it is visible.
@MainActor
